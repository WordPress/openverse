...
To run the API inside Docker, follow the instructions in the {doc}`"Quickstart" <./quickstart>` document.
...
- Docker Compose will automatically load `.env.docker` files inside the container.
