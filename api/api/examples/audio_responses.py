...
audio_detail_200_example = base_audio
...
audio_related_404_example = {"detail": "An internal server error occurred."}
...
audio_waveform_404_example = {"detail": "An internal server error occurred."}
