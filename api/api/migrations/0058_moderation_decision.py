    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('mark', 'Marked sensitive'), ('deidx_copyright', 'Deindexed (copyright)'), ('deidx_sensitive', 'Deindexed (sensitive)'), ('rej', 'Rejected'), ('dedup', 'De-duplicated'), ('rev_mark', 'Reversed deindex'), ('rev_deidx', 'Reversed mark sensitive')], help_text='Action taken by the moderator.', max_length=15)),
