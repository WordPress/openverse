    ...
    <main role="main" class="margin-larger">
      ...
      <i18n path="feedback.description" tag="p">
          <template v-slot:channel>
            <a aria-label="slack cc-usability channel" href="https://creativecommons.slack.com/messages/CCS9CF2JE/details/">#cc-usability</a>
          </template>
      ...
      <div class="column">
        <section class="tabs margin-top-big">
          <ul role="tablist">
            <li role="tab" :class="tabClass(0, 'tab')">
              <a aria-label="help us improve form" href="#panel0" :aria-selected="activeTab == 0" @click.prevent="setActiveTab(0)">
                {{$t('feedback.improve')}}
              </a>
            </li>
            <li role="tab" :class="tabClass(1, 'tab')">
              <a aria-label="report a bug form" href="#panel1" :aria-selected="activeTab == 1" @click.prevent="setActiveTab(1)">
                {{$t('feedback.bug')}}
              </a>
            </li>
          </ul>
        ...
        <section class="tabs-content">
          <div :class="tabClass(0, 'tabs-panel')">
            <iframe aria-label="help us improve form"
          ...
          <div :class="tabClass(1, 'tabs-panel')">
            <iframe aria-label="report a bug form"
