  ...
  <div>
        ...
        <div class="modal">
          ...
          <div
            ...
            <div class="is-flex bottom-filters">
              <div
                class="clear-filters padding-top-normal padding-left-larger
                padding-bottom-normal padding-right-normal margin-top-small">
                <button class="button tiny" @click="onClearFilters">Clear filters</button>
              </div>
              <div
                class="apply-filters padding-top-normal padding-left-large
                padding-bottom-normal padding-right-larger margin-top-small"
                v-if="isFilterApplied">
                <button class="button is-primary tiny" @click.prevent="apply()">
                  Apply filters
                </button>
              </div>
            </div>
    ...
    <div class="is-hidden-touch">
      <div
        ...
        <div class="margin-big padding-bottom-normal clear-filters" v-if="isFilterApplied">
          <button class="button tiny" @click="onClearFilters">Clear filters</button>
        </div>
      </div>
    </div>
