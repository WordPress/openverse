...
<footer class="main-footer">
  <div class="container">
    <div class="columns">
      <section role="complementary" aria-label="cc contact info" class="column">
        <a href="https://creativecommons.org" aria-label="home" class="main-logo margin-bottom-bigger has-text-white">
      ...
      <div class="column">
        <section role="complementary"
            aria-label="donate section" class="donate-section">
