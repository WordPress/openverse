...
import flacWaveform from './flac_waveform.json'
import mp3Waveform from './mp3_waveform.json'
import oggWaveform from './ogg_waveform.json'
import wavWaveform from './wav_waveform.json'
