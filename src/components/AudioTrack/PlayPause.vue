<template>
  <button
    type="button"
    class="flex items-center justify-center bg-dark-charcoal h-20 w-20 transition-shadow duration-100 ease-linear disabled:opacity-70 focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-pink"
    @click="toggle"
  >
