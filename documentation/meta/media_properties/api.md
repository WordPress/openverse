...
| [`audioset`](#Audio-audioset-notes) | [`ForeignObject`](https://docs.djangoproject.com/en/dev/ref/models/fields/#foreignobject)     |         | Many To One  | `AudioSet`       |
...
| [`genres`](#Audio-genres-notes)                                             | [`CharField[]`](https://docs.djangoproject.com/en/dev/ref/contrib/postgres/fields/#arrayfield) | `varchar(80)[]`            | not blank                     |         |
