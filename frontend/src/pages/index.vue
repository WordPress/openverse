...
<template>
  <main
    class="index flex w-full flex-shrink-0 flex-grow flex-col justify-center gap-6 px-6 sm:px-0 lg:h-full lg:flex-row lg:items-center lg:justify-between lg:gap-0"
  >
    <VHomepageContent
