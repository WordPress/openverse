<template>
  <button
    ...
    type="button"
    class="scroll fixed bottom-4 mb-4 ms-auto h-14 w-14 rounded-full bg-pink-8 text-center text-white transition-all duration-100 ease-linear hover:bg-pink-9 hover:shadow-md"
    :class="hClass"
    @click="scrollToTop"
