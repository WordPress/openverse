<template>
  <button
    ...
    type="button"
    class="scroll bg-pink-8 fixed bottom-4 mb-4 ms-auto h-14 w-14 rounded-full text-center text-white transition-all duration-100 ease-linear hover:bg-dark-pink hover:shadow-md"
    :class="hClass"
    @click="scrollToTop"
