<template>
  <div
    ...
    class="snackbar fixed bottom-4 z-snackbar rounded-sm bg-black text-white transition-[opacity,transform] duration-500 ltr:left-4 rtl:right-4 motion-reduce:transition-opacity"
    :class="[
      size === 'large'
        ? 'w-max max-w-[calc(100%_-_2_*_theme(spacing.4))] flex-row items-center px-6 py-4 text-sm'
        : 'w-2/3 flex-col items-start px-4 py-3 text-sr sm:w-2/5',
      isVisible
