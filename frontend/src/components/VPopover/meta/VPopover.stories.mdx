...
export const SinglePopoverStory = (args) => ({
  template: `
    <div>
      ...
      <VPopover v-bind="args" @open="onOpen" @close="onClose">
...
export const TwoPopoverStory = (args) => ({
  template: `
    <div>
      <VPopover label="First popover" v-bind="args">
        <template #trigger="{ visible, a11yProps }">
      ...
      <VPopover label="Second popover" v-bind="args">
        <template #trigger="{ visible, a11yProps }">
