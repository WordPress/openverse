...
@layer components {
  .source-table {
    @apply border-gray-3 hidden rounded-sm border-0 md:table;
  }
  ...
  .source-table th {
    @apply bg-gray-2 cursor-pointer border-t;
  }
  ...
  .mobile-source-table article {
    @apply border-gray-3 grid border-l border-r p-4 sm:grid-cols-4;
  }
