    ...
    <VLink
      ...
      :class="
        isSquare
          ...
          : 'focus-visible:focus-slim-tx focus-visible:sm:focus-bold-filled focus-visible:-m-2 focus-visible:w-[calc(100%+theme(spacing.4))] focus-visible:p-2 sm:focus-visible:m-0 sm:focus-visible:w-full sm:focus-visible:p-0'
      "
