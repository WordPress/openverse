<template>
  <dd class="label-bold flex justify-start overflow-hidden break-words p-1">
    <VLink
      v-if="datum.url"
      :href="datum.url"
      class="flex text-text-link focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring focus-visible:ring-border-focus focus-visible:ring-offset-1"
