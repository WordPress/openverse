  ...
  >
    ...
    >
      <input
        ...
        class="paragraph-large md:label-regular ms-4 h-full w-full appearance-none rounded-none bg-tx leading-none text-text placeholder-gray-8 focus-visible:outline-none"
        :aria-label="
