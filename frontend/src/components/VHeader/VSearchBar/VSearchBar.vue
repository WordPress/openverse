  ...
  <div ref="searchBarEl" class="relative" :class="$attrs.class">
    ...
    >
      <VInputField
        ...
        class="search-field flex-grow border-tx bg-fill-secondary text-secondary focus-within:bg-default focus:border-focus group-hover:bg-fill-secondary group-hover:text-default group-hover:focus-within:bg-default"
