...
const head = {
  ...
  link: [
    ...favicons,
    {
      ...
      // TODO: Check if crossorigin works like this. Typescript complains about "" here.
...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    // Override by the env variables that start with `NUXT_`
    apiClientId: "",
    apiClientSecret: "",
    public: {
      // Override by the env variables that start with `NUXT_PUBLIC_`
