...
Run your tests locally with `just test -k librivox`
"""
...
import pytest
from providers.provider_api_scripts.librivox import LibrivoxDataIngester

# TODO: API responses used for testing can be added to this directory
RESOURCES = Path(__file__).parent / "resources/librivox"
...
def test_get_record_data():
    ...
    # `tests/resources/librivox/single_item.json` file containing a sample
