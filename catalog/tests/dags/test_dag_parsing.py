...
DAG_PATHS = [
    ...
    "elasticsearch/recreate_staging_index/recreate_full_staging_index_dag_factory.py",
...
EXPECTED_COUNT = {
    ...
    "elasticsearch/recreate_staging_index/recreate_full_staging_index_dag_factory.py": len(
        MEDIA_TYPES
    ),
}
