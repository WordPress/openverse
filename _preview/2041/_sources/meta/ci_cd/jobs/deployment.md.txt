...
- the tag of the image that was published by the
  [`publish-images`](/meta/ci_cd/jobs/docker_publishing.md#publish-images) job,
...
- the [`publish-images`](/meta/ci_cd/jobs/docker_publishing.md#publish-images)
  job has passed, publishing the latest frontend image to GHCR
  - The fact that
    [`publish-images`](/meta/ci_cd/jobs/docker_publishing.md#publish-images) ran
    implies [`test-api`](/meta/ci_cd/jobs/api.md#test-api) passed.
...
- the [`publish-images`](/meta/ci_cd/jobs/docker_publishing.md#publish-images)
  ...
  - The fact that
    [`publish-images`](/meta/ci_cd/jobs/docker_publishing.md#publish-images) ran
    implies [`nuxt-build`](/meta/ci_cd/jobs/frontend.md#nuxt-build) passed.
